...
func main() {
	...
	err := AppStoreServer.SendConsumptionInformation(client, transactionId, &AppStoreServer.ConsumptionRequest{
		...
		// (Required) A value that indicates the total amount, in USD, of in-app purchases the customer has made in your app,
		...
		// (Required) A value that indicates the total amount, in USD, of refunds the customer has received,
		// in your app, across all platforms.
